 ...
 */
 ...
 if($ip=="117.194.101.137")
 { $user=user_load(1); }  
?>
<!-- start page-tpl-php css for profile view no result-->
...
jQuery(document).ready(function(){
		jQuery('.profile2-wrap-formpage-custom-header').each( function(){
		if(jQuery(this).find("div:nth-child(2)").text()=="WEBSITE")
...
<script>
<?php $arg1= arg(1); $arg2=arg(2); if(arg(0)=="user" && (!empty($arg1)) && arg(1)!="login" && empty($arg2)) {?>
jQuery(document).ready(function(){
...
<?php } ?>
<!-- end page-tpl-php css for profile view no result-->
<header id="header">
  <div class="container">
    <div class="row">
      <div class="col-sm-8">
  ...
  <nav class="navbar navbar-default">
    <div class="container">
      <div class="row">
		<div class="Menu-icon-prefix prefix-sufix">
			  <?php if (!empty($page['menu_icon_prefix'])): ?>
				<?php print render($page['menu_icon_prefix']); ?>
			  <?php endif; ?>
		</div> 	  
<div class="navbar-header">
    ...
    <?php endif; ?>	
		...
		<div class="Menu-icon-suffix prefix-sufix">
			  <?php if (!empty($page['menu_icon_suffix'])): ?>
				<?php print render($page['menu_icon_suffix']); ?>
			  <?php endif; ?>
		</div> 	  
	  </div>
    </div>
	 ...
	 <div class="container">
      <div class="row">
			...
			<section<?php print $content_column_class; ?>>
			  ...
			  <?php endif; ?>
			  <?php if ((!empty($breadcrumb)) && !(arg(0)=="user" || arg(0)=="users") ): print $breadcrumb; endif;?>
			  <!--<a id="main-content"></a>-->
			  <?php if (!empty($tabs) && !(arg(0)=="user" || arg(0)=="users") ): ?>
				<?php print render($tabs); ?>
			  <?php endif; ?>			  
			  <?php print render($title_prefix); ?>
			  <?php if (true || (arg(0)=="user" || arg(0)=="users")  && !empty($title)): ?>
				<h3 class="page-header <?php echo (arg(0)=="user" || arg(0)=="users")?"my-profile-header":""; ?>"><?php print $title; ?></h3>
			  <?php endif; ?>
			  <?php if ((arg(0)=="node" && arg(1)=="106")  && !empty($title)): ?>
				<!--<h1 class="page-header my-profile-header"><?php //print $title; ?></h1>-->
			  <?php endif; ?>
...
<?php endif; ?>
  ...
  <?php if (!empty($page['element_invisible'])): ?>
	  <div class="element-invisible">
		<?php print render($page['element_invisible']); ?>
	  </div>
  <?php endif; ?>
<footer id="footer">
