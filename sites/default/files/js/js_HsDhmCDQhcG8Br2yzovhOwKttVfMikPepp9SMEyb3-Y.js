...
jQuery('[name="commerce_tax_certificate[tax_certificate][fid]"]').change(function(){
jQuery('#edit-commerce-tax-certificate-save-certificate').show();
	if(jQuery('[name="commerce_tax_certificate[tax_certificate][fid]"]').val()>0)
	jQuery('#edit-commerce-tax-certificate-save-certificate').text('Attach Certificate');
	if(jQuery('[name="commerce_tax_certificate[tax_certificate][fid]"]').val()==0)
	jQuery('#edit-commerce-tax-certificate-save-certificate').text('Detach Certificate');
